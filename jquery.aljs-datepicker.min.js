...
(function($) {
    ...
    Datepicker.prototype = {
        ...
        initInteractivity: function() {
            ...
            // $($el.prev('svg')).on('click', openDatepicker); // Removed for testing
            ...
            if ($elEndDate.length > 0) {
                ...
                // $elEndDate.prev('svg').on('click', openDatepicker); // Removed for testing
        ...
        closeDatepicker: function(e) {
            ...
            if ($target.closest(self.$el.parent()).length === 0 && $selectedInput) {
                ...
                // $datepickerEl.unbind('click', self.processClick); // Removed for testing
            }
        },
        fillMonth: function() {
            var self = this;
